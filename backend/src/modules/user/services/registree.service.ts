...
export class RegistreeService {
  ...
  // async nextAllowedResend(id: string) {
  ...
  //   const { nextAllowedResend, ..._ } = registree;

  //   return { nextAllowedResend };
  // }

  private async prepareRegistrationData(registree: RegistreeDTO) {
