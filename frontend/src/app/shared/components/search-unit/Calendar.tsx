...
export default function Calendar({
  ...
  return (
    <div className="p-[1rem] text-xs bg-white shadow-xl/10 rounded-xl relative lg:text-base lg:pt-[2rem]">
      ...
      <div className="grid grid-cols-7 text-center">
        ...
        {dates.map((date, index) => {
          ...
          return (
            <button
              key={date.date}
              className={`p-[0.5rem] disabled:opacity-50 disabled:cursor-not-allowed ${style}`}
              disabled={past}
