...
export default function FooterMain() {
  return (
    <footer>
      <div className="bg-secondary-normal px-[1.5rem] py-[2rem] text-white md:px-[5rem] lg:flex lg:justify-center lg:py-[3rem]">
        <div className="lg:flex lg:justify-center lg:flex-col lg:w-max">
          <div className="flex items-center gap-x-5">
            ...
            <p className="text-[0.6rem] md:text-xs lg:text-sm">
          ...
          <div className="mt-[2rem] flex">
            <div className="border-r-2 border-white/50 pr-[1rem] md:pr-[1.5rem]">
              <h5 className="text-xs font-bold lg:text-base">FOLLOW US</h5>
            ...
            <div className="pl-[1rem] md:pl-[1.5rem]">
              <h5 className="text-xs font-bold lg:text-base">REACH US OUT</h5>
              <div className="flex flex-col gap-y-2 mt-[0.5rem] md:flex-row md:gap-x-5">
                <div className="flex items-center gap-x-2">
                  ...
                  <a
                    ...
                    className="text-[0.65rem] md:text-xs lg:text-sm"
                  >
          ...
          <div className="mt-[2rem] text-[0.6rem] text-center md:text-xs md:flex md:items-center md:gap-x-5 lg:text-sm">
