...
export default function AddPaymentForm({
  ...
  return (
    <div className="relative text-secondary-normal text-xs px-[1rem] md:px-[1.5rem] lg:px-[2rem] py-[2rem] md:py-[2.5rem] lg:py-[3rem]">
      <h1 className="text-center text-xl md:text-2xl lg:text-3xl font-bold">
        Add Payment Method
      </h1>
      <FormProvider {...methods}>
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="mt-[2rem] md:mt-8 lg:mt-10 px-[0.25rem] pb-[1rem] md:pb-0 md:max-h-none">
            <div className="md:rounded-xl md:border md:border-secondary-normal/10 md:bg-white md:p-6 lg:p-7">
              <div className="hidden md:block mb-5 lg:mb-6">
                ...
                <p className="text-xs lg:text-sm text-gray-500 mt-1">
                  Select the provider and upload the QR destination.
                </p>
              </div>
          ...
          <div className="mt-[1.5rem] md:mt-8 lg:mt-10">
            ...
            <div className="flex items-center justify-center gap-x-7.5 md:gap-10 lg:gap-12">
              <div>
                <PrimaryButton
                  variant="text"
