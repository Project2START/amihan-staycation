...
import PropmptAuthHeader from "@/app/shared/components/PromptAuthHeader";
...
export default async function VerifyInfoPage() {
  ...
  return (
    <>
      <PropmptAuthHeader />
      <div className="mt-[5rem] mx-[1.5rem] text-xs/5">
        <div className="text-center border-2 border-secondary-normal/30 rounded-lg px-[1.5rem] pt-[0.75rem] pb-[2rem]">
