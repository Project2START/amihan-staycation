...
export default function ValuePropSection() {
  return (
    <div className="md:mt-[1rem] lg:mt-[2rem]">
      <div>
      ...
      <div className="grid gap-y-10 border-y-2 border-tertiary-normal/30 py-[2.5rem] lg:gap-y-12 lg:px-[1.5rem] lg:py-[5rem]">
        {values.map((value) => {
          return (
            <div key={value.id} className="flex items-center gap-3">
              ...
              <div className="lg:ml-[1.5rem]">
                <h3>{value.title}</h3>
                <p className="text-xs mt-[0.25rem] md:text-sm lg:text-base">
                  {value.description}
                </p>
              </div>
            </div>
