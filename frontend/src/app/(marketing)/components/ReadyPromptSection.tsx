    ...
    <section>
      <div className="py-10 sm:py-12 md:py-14 lg:py-16 xl:py-20 2xl:py-24 min-[1921px]:py-28">
        ...
        <div className="flex justify-center">
          <Link
            href={"/units"}
            className="primary-button-link px-10 py-4 text-xs sm:px-14 sm:py-4 md:px-16 md:text-sm hover-animation lg:hover:bg-primary-normal/80 lg:px-24 lg:py-5 lg:text-base xl:px-[7.5rem] xl:text-lg 2xl:px-36 min-[1921px]:px-44"
          >
            Browse Units
          </Link>
        </div>
