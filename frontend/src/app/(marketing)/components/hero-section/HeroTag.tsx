...
export default function HeroTag() {
  return (
    <p className="text-shadow-lg text-xs/8 mt-[0.5rem] md:text-sm/10 lg:text-lg/10 lg:mt-[1rem]">
      ...
      <span className="font-bold underline decoration-double decoration-primary-normal lg:text-2xl ">
        <ReactTyped
          strings={[
            "comfort",
            "serenity",
